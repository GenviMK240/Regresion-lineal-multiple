...
modelo_subset <- data.frame(Weight = spear$Weight, spear[, variables_significativas])
modelo_significancia <- lm(Maxle ~ ., data = modelo_subset)
...
print(modelo_subset$Weight)
modelo_subset$Socle <- as.numeric(modelo_subset$Socle)
modelo_subset$Maxwi <- as.numeric(modelo_subset$Maxwi)
modelo_subset$Weight <- as.numeric(modelo_subset$Weight)

scatterplot3d(modelo_subset$Socle, modelo_subset$Maxwi, modelo_subset$Weight, 
              xlab = "Socle", ylab = "Maxwi", zlab = "Weight",
              main = "Modelo Lineal en 3D")

regression_plane <- lm(Weight ~ Socle + Maxwi, data = modelo_subset)
plane3d(regression_plane, col = "blue")
```
